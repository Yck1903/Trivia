...
public class QuestionUI : MonoBehaviour
{
    ...
    private const float _answerButtonDistance = 150;
    ...
    private void GenerateAnswerButtons()
    {
        ...
        Vector2 anchorPos = new Vector2(0, 200);
        ...
        foreach (var answer in QuizData.Answers)
        {
            ...
            anchorPos.y -= _answerButtonDistance;
    ...
    public void HighlightWrongAnswer(string correctAnswer, string givenAnswer)
    {
        foreach (var answerButton in _answerButtons)
        {
    ...
    private void GiveCorrectAnswerFeedback()
    {
        ...
        seq.AppendCallback(() => _answerFeedback.gameObject.SetActive(false));
    }

    private void GiveWrongAnswerFeedback()
    {
